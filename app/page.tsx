...
export default function Home() {
  ...
  return (
    <main className="flex min-h-dvh flex-1 items-center justify-center bg-zinc-100 px-6 py-12 font-sans transition-colors dark:bg-zinc-950">
      <section className="grid w-full max-w-5xl gap-8 md:grid-cols-[1fr_400px] md:items-center">
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="max-w-xl text-4xl font-semibold text-zinc-950 dark:text-zinc-50 sm:text-5xl">
