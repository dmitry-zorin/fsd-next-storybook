...
export function ThemeSwitch() {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className="inline-flex h-10 items-center gap-3 rounded-full border border-zinc-300 bg-white py-1 pl-1 pr-3 text-sm font-medium text-zinc-700 shadow-sm transition hover:border-zinc-400 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:border-zinc-500"
    >
      <span
